...
import { IAssetCount } from 'src/app/interfaces/asset-management.interface.js';

@Component({
  selector: 'app-asset-management-dashboard',
  templateUrl: './asset-management-dashboard.component.html',
  styleUrls: [
    './styles/asset-management-dashboard.component.scss',
    './styles/asset-management-dashboard.responsive.scss'
  ]
})
export class AssetManagementDashboardComponent implements OnInit {
  ...
  constructor(
    ...
    const dashBoardData = this.route.snapshot.data.dashBoardData as IAssetCount;

    this.values = [
      {
        name: 'Assets',
        value: dashBoardData.asset,
        icon: 'orders',
        trend: 6.2,
      ...
      {
        name: 'Preventives',
        value: dashBoardData.preventive,
        icon: 'earnings',
        trend: -10,
